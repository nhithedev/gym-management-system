...
| P3  | rogym-sx-* không có tooling       | Trung bình | Chưa xử lý |
| P4  | State convention inconsistent     | Trung bình | Chưa xử lý |
| P5  | Typography phân tán               | Thấp      | Chưa xử lý |
| P6  | Scrollbar duplicate               | Thấp      | Chưa xử lý |
