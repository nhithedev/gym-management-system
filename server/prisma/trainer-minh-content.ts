...
const upperDay = (
  ...
  exercises: [
    { name: 'Bench Press', sets, reps, durationSec: 45, weightKg: 35 + weekNumber * 2.5, restSec: 90, notes: 'Giữ bả vai cố định trên ghế.' },
    { name: 'Overhead Press', sets: 3, reps: Math.max(6, reps - 2), durationSec: 40, weightKg: 20 + weekNumber * 2.5, restSec: 90, notes: 'Siết core, không ưỡn lưng.' },
    { name: 'Push-up', sets: 3, reps: reps + 4, durationSec: 40, restSec: 60, notes: 'Giữ thân người thành một đường thẳng.' },
    { name: 'Plank', sets: 3, durationSec: 30 + weekNumber * 10, restSec: 45, notes: 'Thở đều và siết mông.' },
  ],
})
...
const lowerDay = (
  ...
  exercises: [
    { name: 'Squat', sets, reps, durationSec: 50, weightKg: 40 + weekNumber * 5, restSec: 120, notes: 'Gối theo hướng mũi chân.' },
    { name: 'Deadlift', sets: 3, reps: Math.max(6, reps - 2), durationSec: 45, weightKg: 50 + weekNumber * 5, restSec: 120, notes: 'Giữ thanh tạ sát chân.' },
    { name: 'Lunge', sets: 3, reps: reps, durationSec: 45, restSec: 60, notes: 'Số rep tính cho mỗi bên.' },
    { name: 'Dead Bug', sets: 3, reps: 10, durationSec: 40, restSec: 45, notes: 'Giữ lưng dưới ổn định.' },
    { name: 'Hamstring Stretch', sets: 2, durationSec: 40, restSec: 20, notes: 'Giữ mỗi bên 40 giây.' },
  ],
})
...
const conditioningDay = (
  ...
  exercises: [
    { name: 'Barbell Row', sets: 3, reps: 10, durationSec: 45, weightKg: 30 + weekNumber * 2.5, restSec: 90, notes: 'Kéo khuỷu về sau, không giật lưng.' },
    { name: 'Pull-up', sets: 3, reps: 6 + weekNumber, durationSec: 35, restSec: 120, notes: 'Dùng dây hỗ trợ nếu cần.' },
    { name: 'Bird Dog', sets: 3, reps: 10, durationSec: 40, restSec: 45, notes: 'Số rep tính cho mỗi bên.' },
    { name: 'Treadmill Run', sets: 1, durationSec: cardioSec, restSec: 0, notes: 'Giữ vùng nhịp tim 65-75% tối đa.' },
    { name: 'Hip Flexor Stretch', sets: 2, durationSec: 40, restSec: 20, notes: 'Giữ mỗi bên 40 giây.' },
  ],
})

export const TRAINER_MINH_FOUR_WEEK_PLAN: PlanDay[] = [
  upperDay(1, 1, 3, 10),
  lowerDay(1, 2, 3, 10),
