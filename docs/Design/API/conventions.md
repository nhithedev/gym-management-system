...
| 404 | `RESOURCE_NOT_FOUND` | Domain-specific variant — explicit `NotFoundException` throw trong module code (không phải Prisma P2025 auto-map). Cùng HTTP 404, khác code string. |
