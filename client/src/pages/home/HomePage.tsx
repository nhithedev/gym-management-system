  ...
  return (
    <nav className={`rogym-navbar ${scrolled ? 'rogym-navbar--scrolled' : ''}`}>
      <div className="rogym-container h-16 flex items-center justify-between">
        ...
        <Link
          to="/"
          className="flex items-center gap-2.5 shrink-0 rogym-sx-bc605c49"
          
        >
          <div
            className="w-8 h-8 rounded-lg flex items-center justify-center rogym-sx-1c639e32"
            
          >
            <Dumbbell size={16} color="#fff" strokeWidth={2.2} />
          </div>
          <span
            className="rogym-sx-f6d7ded8"
          >
            ROGYM
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-3">
          <NavLinkBtn to="/login" variant="green">
            Đăng nhập
          </NavLinkBtn>
          <NavLinkBtn to="/member/register" variant="outline">
            Đăng ký
          </NavLinkBtn>
        </div>
      ...
      {open && (
        <div
          className="md:hidden px-10 pb-6 flex flex-col gap-4 rogym-sx-eb71f2b0"
...
function HeroSection() {
  return (
    <section className="relative w-full min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-w-[1280px] mx-auto px-10 w-full pt-24 pb-20">
        <div className="max-w-[640px]">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span
              className="rogym-sx-e07a83ed"
            >
              ROGYM — Đỉnh cao phong độ
            </span>
          </div>
          <h1
            className="uppercase leading-none mb-6 rogym-sx-5ba16c42"
          ...
          <p
            className="mb-8 max-w-[500px] rogym-sx-f2f202e3"
          ...
          <div className="mt-14 flex gap-10 flex-wrap">
            {[
              ...
              <div key={l}>
                <div
                  className="rogym-sx-7cd3ffb3"
                >
                  {n}
                </div>
                <div
                  className="rogym-sx-d26a35f2"
                >
                  {l}
                </div>
              </div>
      ...
      <div
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 rogym-sx-448054ab"
        
      >
        <span
          className="rogym-sx-a3416a9a"
        >
          Cuộn xuống
        </span>
...
function FeatureBar() {
  return (
    <div
      className="rogym-marquee w-full overflow-hidden py-5 border-y rogym-sx-45cdf5dd"
...
function TrainingCard({
  ...
  return (
    <div
      className="rogym-media-card rogym-media-card--dark relative rounded-[40px] overflow-hidden cursor-pointer rogym-sx-6063d874"
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 rogym-sx-23c73807"
        
      />
      <div className="absolute bottom-0 left-0 right-0 p-8">
        <span
          className="inline-block px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-3 rogym-sx-f1d39d6f"
          
        >
          {tag}
        </span>
        <div
          className="uppercase mb-3 rogym-sx-7989cb59"
          
        >
          {title}
        </div>
        <p
          className="rogym-sx-0d114162"
        >
          {desc}
        </p>
        <button
        ...
        >
          <span
            className="text-sm font-bold uppercase tracking-widest rogym-sx-3278ee06"
...
function TrainingSection() {
  return (
    <section
      className="w-full py-32 relative rogym-sx-d8b3875b"
    ...
    >
      <div className="max-w-[1280px] mx-auto px-10">
        <div className="flex items-end justify-between mb-16 flex-wrap gap-6">
          <div>
            <div
              className="text-xs font-bold uppercase tracking-[0.3em] mb-4 rogym-sx-9cd1aaa6"
              
            >
              LEVEL UP YOUR GAME
            </div>
            <h2
              className="uppercase leading-none rogym-sx-37943c0d"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {EXTRA_PROGRAMS.map(([Icon, name, desc]) => (
            <div key={name} className="rogym-mini-card p-6 rounded-2xl cursor-pointer">
              <div
                className="mb-3 w-10 h-10 rounded-xl flex items-center justify-center rogym-sx-30aed1d5"
                
              >
                <Icon size={20} color={T} strokeWidth={2} />
              </div>
              <div
                className="font-semibold mb-1 rogym-sx-8c53a34a"
                
              >
                {name}
              </div>
              <div
                className="rogym-sx-add1c712"
              >
                {desc}
              </div>
            </div>
...
function CoachCard({
  ...
  return (
    <div
      className="rogym-media-card rogym-media-card--light relative cursor-pointer rogym-sx-38f967f1"
      
    >
      <div
        className="rogym-media-card__frame rounded-[40px] rogym-sx-cbae9426"
        
      >
        <div
          className="absolute inset-0 rounded-[40px] rogym-sx-a428c28c"
          
        />
        <img src={img} alt={name} className="rogym-media-card__image w-full h-full object-cover" />
        <div
          className="rogym-media-card__tint absolute inset-0 rounded-[40px] rogym-sx-3592cfe5"
          
        />
      </div>
      <div className="text-center mt-5">
        <div
          className="uppercase rogym-sx-f7b2327a"
          
        >
          {name}
        </div>
        <div
          className="font-semibold uppercase tracking-wider mt-1 rogym-sx-7479d1c6"
          
        >
          {role}
        </div>
        <div
          className="mt-1.5 rogym-sx-dde31fe9"
...
function CoachSection() {
  return (
    <section className="w-full py-32 bg-white relative overflow-hidden">
      <div
        className="absolute inset-0 pointer-events-none rogym-sx-bee9a30c"
        
      />
      <div className="max-w-[1280px] mx-auto px-10 relative">
        <div className="text-center mb-20">
          <h2
            className="uppercase leading-none mb-5 rogym-sx-339ac6c6"
            
          >
            ĐỘI NGŨ CHUYÊN GIA
          </h2>
          <p
            className="uppercase font-semibold tracking-[0.15em] opacity-50 rogym-sx-8b36c264"
...
function PricingCard({ plan }: { plan: Plan }) {
  ...
  return (
    ...
    >
      {hot && (
        <div
          className="absolute -top-4 left-1/2 -translate-x-1/2 px-5 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest rogym-sx-15e311e3"
      ...
      <div className="flex items-baseline gap-2 mb-8">
        <span className="rogym-pricing-card__price">
          {plan.price}
        </span>
        <span className="rogym-pricing-card__unit">
          {plan.unit}
        </span>
      </div>
      <div className="flex flex-col gap-4 mb-10 flex-1">
        {plan.features.map((f) => (
          <div key={f} className="flex items-start gap-3">
            ...
            <span className="rogym-pricing-card__feature">
              {f}
            </span>
          </div>
        ))}
...
function PricingSection() {
  ...
  return (
    <section className="w-full py-32 relative rogym-sx-7b5fda64" >
      <div
        className="absolute inset-0 pointer-events-none rogym-sx-49e5c51a"
        
      />
      <div className="max-w-[1280px] mx-auto px-10 relative">
        <div className="text-center mb-20">
          <h2
            className="uppercase leading-none mb-5 rogym-sx-37943c0d"
        ...
        <p
          className="text-center mt-12 rogym-sx-0ac692a1"
...
function CTABanner() {
  return (
    <section className="w-full py-28 relative overflow-hidden rogym-sx-3645accf" >
      <div
        className="absolute inset-0 pointer-events-none rogym-sx-4c20acf6"
        
      />
      <div className="max-w-[1280px] mx-auto px-10 text-center relative">
        <p
          className="uppercase font-bold tracking-[0.28em] mb-4 rogym-sx-4c894103"
          
        >
          BẮT ĐẦU HÀNH TRÌNH CỦA BẠN
        </p>
        <h2
          className="uppercase leading-none mb-8 rogym-sx-1297467b"
        ...
        <p
          className="max-w-md mx-auto mb-10 rogym-sx-31cf2166"
...
function Footer() {
  ...
  return (
    <footer
      className="w-full py-20 border-t rogym-sx-12fc93c6"
    ...
    >
      <div className="max-w-[1280px] mx-auto px-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div>
            <div className="flex items-center gap-2.5 mb-5">
              <div
                className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 rogym-sx-1c639e32"
                
              >
                <Dumbbell size={16} color="#fff" strokeWidth={2.2} />
              </div>
              <span
                className="rogym-sx-7722cdfa"
              >
                ROGYM
              </span>
            </div>
            <p
              className="mb-6 rogym-sx-6c6fd0c8"
          ...
          {Object.entries(cols).map(([cat, links]) => (
            <div key={cat}>
              <div
                className="text-xs font-bold uppercase tracking-[0.2em] mb-5 rogym-sx-e539da0b"
        ...
        <div
          className="flex items-center justify-between flex-wrap gap-4 pt-8 border-t rogym-sx-3636a8d8"
          
        >
          <span
            className="rogym-sx-f419f934"
          >
            © 2026 RoGym. All rights reserved.
          </span>
          <span
            className="rogym-sx-f419f934"
          >
